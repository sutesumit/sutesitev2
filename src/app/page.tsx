  ...
  return (
    <article className="p-10 container flex items-center h-screen font-roboto-mono lowercase">
      <div>
        ...
        <br/> */}
        <div className="group">
          {/* Before I ever wrote a line of JavaScript: */}
          <HoverTextTyper
            triggerText="Before I ever wrote a line of JavaScript:"
            typingText="I told stories through visuals, writing, and design experiments. From documenting atrocity and resilience on the ground for The Wire to shaping the visual voice for the headlines at Hindustan Times, I learned how narratives move through people. At Fields of View, I wove art, data, and design into participatory games and tools for policymaking, and at the Ambedkar Reading Circle, I fused systems thinking, dramaturgy and code to create Dramas of Discrimination — an open-source toolkit for inclusive practices."
          />
        </div>
        <br />
        <p>
          Today, as a fullstack developer at{" "}
          <Link
            target="_blank"
            className="border-[1px] border-opacity-25 dark:border-opacity-25 bg-blue-100 dark:bg-blue-950 border-blue-900 dark:border-blue-400 rounded-sm px-1"
            href="https://beneathatree.com/"
          >
            beneathAtree
          </Link>
          , I build end-to-end features for a senior living system using React, Redux, AWS Lambda, and MongoDB, reducing caregiver task turnaround time.
        </p>
        <br />
        <p>I continue to draw from the same creative instincts. And my interactive digital art continues to explore the intersection of personal archives, inherited emotions, and the political — imagining the web as a space for artistic expression and self-reflection.</p>
        <br />
