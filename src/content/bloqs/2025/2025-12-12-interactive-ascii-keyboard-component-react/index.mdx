...
slug: "interactive-ascii-keyboard-component-react"
tags:
  - react
  - typescript
  - animation
...
import SeedingPlantWrapped from "./SeedingPlantWrapped";
...
<div>A colleague at work, <a href="https://thoran.art/" target="_blank" className="highlight">Bijoy</a>, asked if he could reuse this `<SeedingPlant />`<SeedingPlant /> <SeedingPlantWrapped /> component for his own personal site. That got me thinking—why not start publishing my handwoven components here? I’ve also baked in some distinct interaction design feedback from <a href="https://adilhamza.art/" target="_blank" className="highlight">Adil</a> to make it feel tactile and responsive.</div>
