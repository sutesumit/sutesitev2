...
slug: "building-view-counter-nextjs-supabase"
tags:
  - nextjs
  - react
  - supabase
...
<div className="flex items-center justify-center text-sm my-4 not-rose">
  <ViewCounter className="flex flex-row justify-center items-center blue-border w-fit p-1" slug="building-view-counter-nextjs-supabase" />
</div>
