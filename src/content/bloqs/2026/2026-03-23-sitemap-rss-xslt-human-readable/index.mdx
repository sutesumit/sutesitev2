...
If you open my sitemap now at [`/sitemap.xml`](/sitemap.xml), the XML is basically the site saying: here are the pages, and here is my best attempt at not sending you on a recursive walk through internal links with a rate limit.
...
Once [`/sitemap.xml`](/sitemap.xml) existed, it was technically correct. Which is to say: useful for crawlers, mildly hostile for humans, and aesthetically similar to being handed a spreadsheet in a stairwell.
