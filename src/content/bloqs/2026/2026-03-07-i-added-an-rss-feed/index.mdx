...
The IndieWeb community [puts it well](https://indieweb.org/RSS): "Having an RSS feed makes your content more discoverable to your target audience because visitors do not need to manually check your site for new posts."
...
1. Download a reader. [NetNewsWire](https://netnewswire.com/) for Mac/iOS. [Feedly](https://feedly.com/) for web. [Newsboat](https://newsboat.org/) for terminal enthusiasts.
...
And if you want to subscribe to this site, the feed is at [sumitsute.com/feed.xml](/feed.xml). The orange icon in the footer will take you there.
