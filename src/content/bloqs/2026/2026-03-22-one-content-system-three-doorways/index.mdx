...
[Placeholder: Telegram screenshot showing `/byte`, `/blip`, `/list`, `/edit` in a real chat]

[Placeholder: CLI screenshot showing `jot "ship the thought"`, `jot blip add`, `jot byte ls`]
...
[Placeholder: Telegram channel screenshot showing a byte or bloq broadcast]
...
[Placeholder: Side-by-side image, Telegram command flow on the left, CLI command flow on the right]
...
|----------------|----------------------------------------|---------------------------------|
| Telegram bot   | allowed Telegram user IDs and webhook  | only I should be able           | 
|                | verification                           | to mutate content through chat  |
...
| API            |                                        | to announce a post without      |
...
[Placeholder: Telegram UX screenshot with a quick byte capture]

[Placeholder: CLI UX screenshot showing list, inspect, and edit flow]
