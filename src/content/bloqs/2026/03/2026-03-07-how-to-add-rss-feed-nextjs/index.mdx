...
slug: "how-to-add-rss-feed-nextjs"
tags:
  - nextjs
  - backend
  - seo
...
## The Iconic <CopyLink className='inline-flex blue-border p-1 rounded-sm items-center justify-center hover:text-orange-500 hover:bg-orange-500/10 cursor-pointer transition-all duration-200' href='/feed.xml'><MdOutlineRssFeed /></CopyLink>.
