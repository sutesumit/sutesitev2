...
slug: "spec-driven-development-clap-feature-nextjs"
tags:
  - backend
  - typescript
  - nextjs
...
<div className="flex justify-center text-sm my-4 not-prose">
  <ClapsCounter
    postId="spec-driven-development-clap-feature-nextjs"
    postType="bloq"
    interactive={true}
    className=""
  />
...
I almost started coding. Then I remembered the [View Counter Incident of Last Month](/bloq/building-view-counter-nextjs-supabase)—a refactor that took three times longer than expected because I kept discovering requirements mid-build. I'd written the same API route three times. I'd rather not talk about it.
...
- **Design for the third case.** When you're building for two of something, ask what happens when there's a third. The answer tells you whether to unify or separate. I learned this from [a cauliflower at a vegetable shop](/bloq/building-mdx-blog-system-nextjs-ai), but that's a different article.
